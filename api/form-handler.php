...
/**
 * Endpoint único de formulário em soarinho.com/api/form-handler.php
 *
 * Cada landing page envia:
 * - site: identificador da origem (hub, voz, musica, edicao, web, suporte, dev, editor...)
